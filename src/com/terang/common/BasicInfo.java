...
public class BasicInfo {
	 ...
	 * 손글씨 저장 위치
	 */
	public static String FOLDER_HANDWRITING 	= "draw/handwriting/";

	/**
	 * 데이터베이스 이름
	 */
	public static String DATABASE_NAME = "draw/draw.db";


	//========== 인텐트 부가정보 전달을 위한 키값 ==========//
	public static final String KEY_MEMO_MODE = "MEMO_MODE";
	public static final String KEY_MEMO_TEXT = "MEMO_TEXT";
	public static final String KEY_MEMO_USER = "MEMO_USER";
	...
	public static final int REP_DELETE_ACTIVITY = 7001;
	public static final int REP_INSERT_ACTIVITY = 7002;
